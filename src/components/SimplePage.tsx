...
const PAGES: Record<string, { icon: typeof Info; titleFr: string; titleEn: string; bodyFr: string; bodyEn: string }> = {
  about: {
    ...
    titleEn: 'About Faka',
    bodyFr: `Faka est une plateforme de gestion des ressources humaines conçue pour les entreprises africaines. Développée par LIYAH GROUP, Faka digitalise le cycle complet du collaborateur : contrats, paie multicanal, congés, présence, recrutement, formation et conformité.\n\nNotre mission : rendre la gestion RH simple, accessible et conforme aux réalités du continent — paiements mobiles, multi-devises, bilingue FR/EN, isolation multi-tenant stricte.`,
    bodyEn: `Faka is a human resources management platform built for African businesses. Developed by LIYAH GROUP, Faka digitizes the complete employee lifecycle: contracts, multi-channel payroll, leave, attendance, recruitment, training and compliance.\n\nOur mission: make HR management simple, accessible and adapted to the realities of the continent — mobile payments, multi-currency, bilingual FR/EN, strict multi-tenant isolation.`,
  },
  contact: {
    icon: Mail,
    titleFr: 'Contactez-nous',
    titleEn: 'Contact us',
    bodyFr: `LIYAH GROUP\nEmail : contact@liyahgroup.com\nTéléphone : +237 6XX XXX XXX\nDouala, Cameroun\n\nPour le support technique : support@faka-hr.com\nPour les partenariats : partners@liyahgroup.com`,
    bodyEn: `LIYAH GROUP\nEmail: contact@liyahgroup.com\nPhone: +237 6XX XXX XXX\nDouala, Cameroon\n\nTechnical support: support@faka-hr.com\nPartnerships: partners@liyahgroup.com`,
  },
  privacy: {
    icon: Lock,
